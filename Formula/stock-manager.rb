class StockManager < Formula
  ...
  url "https://github.com/shartith/StockManager/releases/download/v4.7.2/stock-manager-4.7.2.tar.gz"
  sha256 "6957b2d610ea2e1b8f805033581a210f7f7b17bdf5de9ceeed029de161534f41"
  license "MIT"
  version "4.7.2"
  depends_on "node"
