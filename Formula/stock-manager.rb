class StockManager < Formula
  ...
  url "https://github.com/shartith/StockManager/releases/download/v1.2.1/stock-manager-1.2.1.tar.gz"
  sha256 "a2db25cd4a93137b34c6fb376a311e82604df958e5efc312babfde940454188f"
  license "MIT"
  version "1.2.1"
